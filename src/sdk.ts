...
export class PaddleSDK {
  ...
  async getSubscriptionPlan(planID: number) {
    return this._first(
      await this._request<GetSubscriptionPlansResponse, GetSubscriptionPlansBody>(
        '/subscription/plans',
        {
          body: { plan: planID },
        },
  ...
  getSubscriptionPayments(
    ...
    return this._request<GetSubscriptionPaymentsResponse, GetSubscriptionPaymentsBody>(
...
=	 * @example
   ...
   */
  verifyWebhookData(postData: { p_signature: string } & Record<string, unknown>): boolean {
  ...
  updateSubscription(
    ...
    return this._request<UpdateSubscriptionUserResponse, UpdateSubscriptionUserBody>(
  ...
  getUsers(options?: {
    ...
    return this._request<GetSubscriptionUsersResponse, GetSubscriptionUsersBody>(
      '/subscription/users',
      { body },
    );
  }
   ...
   */
  getSubscriptionModifiers(options?: { subscriptionID?: number; planID?: number }) {
    ...
    return this._request<GetSubscriptionModifiersResponse, GetSubscriptionModifiersBody>(
  ...
  createSubscriptionModifier(
    ...
    return this._request<CreateSubscriptionModifierResponse, CreateSubscriptionModifierBody>(
  ...
  deleteSubscriptionModifier(modifierId: number) {
    ...
    return this._request<true, DeleteSubscriptionModifierBody>('/subscription/modifiers/delete', {
      body,
    });
  }
  ...
  serverURL(checkoutAPIVersion?: CheckoutAPIVersion): string {
    return (
      ...
      (this.options && this.options.sandbox ? VENDOR_SANDBOX_URL : VENDOR_SERVER_URL)
    );
  }

  private getCheckoutURL(checkoutAPIVersion: CheckoutAPIVersion): string {
    if (this.options && this.options.sandbox) {
      return checkoutAPIVersion === 'v1' ? CHECKOUT_SANDBOX_V1_URL : CHECKOUT_SANDBOX_V2_URL;
    }
    return checkoutAPIVersion === 'v1' ? CHECKOUT_SERVER_V1_URL : CHECKOUT_SERVER_V2_URL;
  }
